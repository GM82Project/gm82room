    ...
    switch (uaction) {
        ...
        case act_change: {
            if (lmode==0) do {
                ...
                if (o<100000 or !instance_exists(o)) {show_error("Error undoing a change: instance id "+string(o)+" is invalid",1) exit}
            ...
            if (lmode==1) do {
                o=ds_map_find_value(uidmap,ds_list_find_value(l,i))
                if (o<100000 or !instance_exists(o)) {show_error("Error undoing a change: tile id "+string(o)+" is invalid",1) exit}

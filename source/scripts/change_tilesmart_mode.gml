if (tilebgpal!=noone) {
    if (bg_tilemode[tilebgpal]!=-argument0 and bg_tilemode[tilebgpal]!=0 and bg_tilemode[tilebgpal]!=6 and bg_tilemode[tilebgpal]!=7) {
    ...
    tilemap_complete=(bg_tilemode[tilebgpal]==6 or bg_tilemode[tilebgpal]==7)
    atcx=0
    atcy=0
}

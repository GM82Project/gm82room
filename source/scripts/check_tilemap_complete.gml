...
tilemap_complete=false
autotiler_is_adjacent=false

if (tilebgpal!=noone) {
    if (bg_tilemode[tilebgpal]==7 or bg_tilemode[tilebgpal]==8) tilemap_complete=true
    ...
    if (bg_tilemode[tilebgpal]!=1 and bg_tilemode[tilebgpal]!=7 and bg_tilemode[tilebgpal]!=8) autotiler_is_adjacent=1
}

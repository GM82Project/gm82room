globalvar
    ...
    sprites,backgrounds,objects,sprloaded,sprloaded_len,bgloaded,objloaded,objparent,objpersist,objsolid,objspr,objmask,objvis,objdepth,bghastiles,bgsmallicon,
    ...
    path_precision,current_path,current_pathpoint,drag_point,current_pathname,path_thin,pathmap_path,pathmap_model,pathmap_edited,pathmap_fields,path_sel,pathfocus,

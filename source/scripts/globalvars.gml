globalvar
    ...
    bg_tilemode,hide_smartmap,bg_tilemap,tilemap_complete,autotiler_tables,autotiler_last_click,autotiler_rectangle,autotiler_rectangle_x,autotiler_rectangle_y,

globalvar
    ...
    bg_gridx,bg_gridy,bg_gridox,bg_gridoy,bg_gridsx,bg_gridsy,bg_istile,bg_tilemode,hide_smartmap,bg_tilemap,tilemap_complete,autotiler_tables,autotiler_last_click,

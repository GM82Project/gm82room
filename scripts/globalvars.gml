globalvar
    ...
    objfields,objfieldname,objfieldtype,objfieldargs,objdesc,objfielddef,objnodrawself,objshow,objfielddepends,objfieldindent,
    ...
    codeeditortype,colorpickertype,hide3dgizmo,cropbackgrounds,swaprmb,rmbalwaysdel,

if (mode==5) {
    begin_trim(0,120,160,height-332-120)
    ...
    draw_button_ext(0,height-276,160,176,1,noone)
    draw_text(12,height-276+8,"Point:")
    draw_text(18,height-276+68,"of "+string(path_get_number(current_path)))
